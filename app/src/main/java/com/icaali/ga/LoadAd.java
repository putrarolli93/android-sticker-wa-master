...
import com.icaali.StickerPrabowoGibran.R;
import com.icaali.StickerPrabowoGibran.StickerPackListActivity;
...
//        InterstitialAd interstitialAd = new InterstitialAd(StikerApp.Companion.getAppContext());
//        interstitialAd.setAdUnitId(StikerApp.Companion.getAppContext().getString(R.string.ad_interstitial_id)); // AdMob interstitial ad unit id
